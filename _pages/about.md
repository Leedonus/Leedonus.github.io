...
*ICLR, 2026.* A reinforced cognitive driving framework that integrates vision-language reasoning with a diffusion planner for continuous trajectory generation.<br>
[[Paper](https://arxiv.org/abs/2506.08052)] [[Code](https://github.com/xiaomi-research/recogdrive)]
...
*arXiv, 2026.* A unified VLA and world-model framework that performs latent reasoning and trajectory planning in one parallel forward pass.<br>
[[Paper](https://arxiv.org/abs/2604.18486)] [[Code](https://github.com/xiaomi-research/onevl)] [[Project](https://xiaomi-embodied-intelligence.github.io/OneVL/)]
...
*CVPR, 2026.* An RL framework that diagnoses persistent planning failures and feeds structured corrective samples back into policy optimization.<br>
[[Paper](https://arxiv.org/abs/2603.01063)]
...
*ICRA, 2026.* A dual-mode VLA framework that learns when to use fast direct prediction and when to invoke explicit chain-of-thought reasoning.<br>
[[Paper](https://arxiv.org/abs/2509.13769)]
...
*arXiv, 2026.* A physically grounded latent reasoning framework that aligns VLA representations with 3D geometry and future scene dynamics.<br>
[[Paper](https://arxiv.org/abs/2603.01928)]
...
*arXiv, 2026.* A streaming vision-geometry-action model that jointly reconstructs dense 3D geometry and generates driving trajectories online.<br>
[[Paper](https://arxiv.org/abs/2604.00813)]
...
*arXiv, 2026.* A temporally grounded driving evaluation dataset and a specialized generative vision-language reward model for reinforcement learning and trajectory selection.<br>
[[Paper](https://arxiv.org/abs/2606.08525)]
...
*AAAI, 2026.* A VLM-based trajectory adversary that generates challenging long-tail scenarios inside the closed-loop policy-training process.<br>
...
*arXiv, 2026.* A geometry-grounded world-action model that uses present and future 3D geometry to guide safe and efficient trajectory planning.<br>
[[Paper](https://arxiv.org/abs/2607.17521)]
...
*arXiv, 2025.* A synthetic high-risk motion dataset and VLM-based agent for spatial motion-risk prediction in autonomous driving.<br>
[[Paper](https://arxiv.org/abs/2507.02948)] [[Code](https://github.com/xiaomi-research/drivemrp)]
...
*CVPR, 2026.* A driving-oriented visual geometry foundation model for metric-scale dense 3D reconstruction from unposed multi-view image sequences.<br>
[[Paper](https://arxiv.org/abs/2512.16919)] [[Code](https://github.com/wzzheng/DVGT)] [[Project](https://wzzheng.net/DVGT/)]
...
*ICRA, 2026.* A unified 3D Gaussian representation that jointly captures scene geometry and texture for autonomous-driving visual pre-training.<br>
[[Paper](https://arxiv.org/abs/2411.12452)] [[Code](https://github.com/Public-BOTs/GaussianPretrain)]
...
*IEEE Transactions on Circuits and Systems for Video Technology, 2026.* A target-level geometric distillation method that transfers LiDAR spatial knowledge to camera-based BEV detectors.<br>
[[Paper](https://arxiv.org/abs/2412.20911)] [[Code](https://github.com/Public-BOTs/TiGDistill-BEV)]
...
*ACM Multimedia, 2024.* A sparse radar-camera interaction framework that filters noisy radar features and resolves positional ambiguity using image semantics.<br>
[[Paper](https://doi.org/10.1145/3664647.3681565)] [[Code](https://github.com/GG-Bonds/SparseInteraction)]
...
*arXiv, 2026.* A unified camera-centric action representation for pre-training one policy across heterogeneous robot embodiments and human demonstrations.<br>
...
**Fang Li**, et al.<br>
*2026.* A curriculum-based transition-learning framework for improving spatial reasoning and action selection in vision-language navigation.<br>
...
*ACL, 2026. Oral* A hierarchical navigation framework that combines VLM-based short-horizon reasoning with reinforcement-learning-based low-level execution.<br>
[[Paper](https://arxiv.org/abs/2604.17407)]
...
- *YYYY*: Award name, organization.

## Services

- Reviewer for conferences and journals in machine learning and computer vision.
